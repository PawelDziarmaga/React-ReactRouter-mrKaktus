...
class Rosliny extends React.Component {
    state = {  }
    render() { 

        //const elements = API.rosliny.map(elemrnt => <p>{elements.name}</p>)
        return ( 
           <>
           <div className="listPage">
                ...
                <NavLink to="/rosliny/grubosz">
                    <div className="box">
                        ...
                        <p>{API.rosliny.grubosz.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                    </div>
                </NavLink>
                <NavLink to="/rosliny/fikus">
                        <div className="box">
                            ...
                            <p>{API.rosliny.fikus.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                        </div>
                </NavLink>
            </div>
