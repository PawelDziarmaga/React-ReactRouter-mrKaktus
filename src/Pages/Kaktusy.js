...
class Kaktusy extends React.Component {
    state = {  }
    render() { 

        //const elements = API.kaktusy.map(elemrnt => <p>{elements.name}</p>)
        return ( 
           <>
           <div className="listPage">
                ...
                <NavLink to="/kaktusy/szczepiony">
                    <div className="box">
                        ...
                        <p>{API.kaktusy.szczepiony.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                    </div>
                </NavLink>
                <NavLink to="/kaktusy/opuncja">
                        <div className="box">
                            ...
                            <p>{API.kaktusy.opuncja.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                        </div>
                </NavLink>
            </div>
