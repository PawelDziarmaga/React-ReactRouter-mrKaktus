...
class Sukulenty extends React.Component {
    state = {  }
    render() { 

        //const elements = API.sukulenty.map(elemrnt => <p>{elements.name}</p>)
        return ( 
           <>
           <div className="listPage">
                ...
                <NavLink to="/sukulenty/aloes">
                    <div className="box">
                        ...
                        <p>{API.sukulenty.aloes.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                    </div>
                </NavLink>
                <NavLink to="/sukulenty/sansewieria">
                        <div className="box">
                            ...
                            <p>{API.sukulenty.sansewieria.firstShortInfo}<br/><br/><span>Więcej...</span></p>
                        </div>
                </NavLink>
            </div>
